...
const WhatWeOffer: FC<WhatWeOfferProps> = ({ }) => {
    return <section id='offer'  className='scale-75 py-0  md:scale-100 text-slate-900  md:py-40  px-5'>
        ...
        <div className=' flex justify-evenly gap-20 flex-wrap'>
            ...
            <div className={`${props} max-w-lg  `}> <Image className='absolute -left-10 scale-150 top-1.5 ' src={square} alt=''></Image>
            ...
            <div className={`${props} max-w-lg `}> <Image className='absolute -left-10 scale-150 top-1.5 ' src={computer} alt=''></Image>
            ...
            <div className={`${props} max-w-lg `}> <Image className='absolute -left-10 scale-150 top-1.5 ' src={palm} alt=''></Image>
            ...
            <div className={`${props} max-w-lg `}> <Image className='absolute -left-10 scale-150 top-1.5 '  src={headPhones} alt=''></Image>
                <h4 className=' mb-6 font-bold tracking-widest text-2xl'>Long term support
                </h4>
                <FadeIn delay={0.2}>
                    <p className=' text-lg tracking-tight leading-7 text-slate-900 '>We prefer to be in touch with our customers for a long time. We build strong and trusting relationships by supporting our customers' projects 24/7. </p>
                </FadeIn>
            </div>
            <div className={`${props} max-w-lg `}> <Image className='absolute -left-10 scale-150 top-1.5 ' src={star} alt=''></Image>
