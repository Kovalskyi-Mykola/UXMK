...
const WhatWeOffer: FC<WhatWeOfferProps> = ({ }) => {
    return <section id='offer' className=' py-0 mb-32  md:scale-100 text-slate-900  md:py-40  '>
        ...
        <div className=' flex justify-evenly gap-20 flex-wrap'>
            ...
            <div className={`${props} max-w-lg  `}> <Image className='absolute left-2 md:-left-10 scale-150 top-7 ' src={square} alt='someinfo'></Image>
            ...
            <div className={`${props} max-w-lg `}> <Image className='absolute left-2 md:-left-10 scale-150 top-7 ' src={computer} alt='someinfo'></Image>
            ...
            <div className={`${props} max-w-lg `}> <Image className='absolute left-2 md:-left-10 scale-150 top-7 ' src={palm} alt='someinfo'></Image>
            ...
            <div className={`${props} max-w-lg `}> <Image className='absolute left-2 md:-left-10 scale-150 top-7 ' src={headPhones} alt='someinfo'></Image>
            ...
            <div className={`${props} max-w-lg `}> <Image className='absolute left-2 md:-left-10 scale-150 top-7 ' src={star} alt='someinfo'></Image>
